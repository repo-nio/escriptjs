/*******************************************************************************************************
	...
	Description: 	This script is designed to integrate Nixxis Contact Suite 2.4.x/3.x (webview2) with Seeasoftware's E-Script script editor
...
******************************************************************************************************
	...
	Functions:
		...
		NixxisScript.Utilities.validateEmail(email)
		...
		**/
		StartRecording : function() {
			...
			try {
			  ...
			  console.log(NixxisContactLink.contactId + ' test');
