...
******************************************************************************************************
	...
	Functions:
		...
		NixxisScript.Utilities.ToSqlDateTime()
...
LastError: null,
	...
	Common: {
		...
		**/
		NixxisInit: function () {
			...
			// Creating global variables for Qualifications
			_Pr._S.GlbVar['NixxisVar_QalId'] = { value: '', type: 'String' };
			_Pr._S.GlbVar['NixxisVar_QalDesc'] = { value: '', type: 'String' };
			_Pr._S.GlbVar['NixxisVar_QalAction'] = { value: '', type: 'String' };
			_Pr._S.GlbVar['NixxisVar_QalDate'] = { value: '', type: 'String' };
			_Pr._S.GlbVar['NixxisVar_QalDateTxt'] = { value: '', type: 'String' };
			_Pr._S.GlbVar['NixxisVar_QalTime'] = { value: '', type: 'String' };
			_Pr._S.GlbVar['NixxisVar_QalPhone'] = { value: '', type: 'String' };

			// Creating global variables for AutoSearch
			_Pr._S.GlbVar['NixxisVar_as_queryres'] = { value: '', type: 'String' };

			// Creating global variables for Pop up
		...
		**/
		CloseScript: function () {
			window.external.terminateContact();
		},
	...
	Utilities: {
		// NixxisScript.Utilities.function()
