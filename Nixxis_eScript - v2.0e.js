/*******************************************************************************************************
	...
	Version: 		v2.0e based on v1.0n and v2.0d
...
var NixxisScript = {
	...
	KEY_PLUGIN: null,
	appURI: "10.67.0.27:8088",
	dataURI: "http://10.67.0.27:8088/data",
	host: "10.67.0.27",
	...
	Qualifications : {
		...
		GetQualification : function (
		  ...
		  try {
			...
			if (isPositive) includePositive = true;
	
			if (isNeutral) includeNeutral = true;
	
			if (isNegative) includeNegative = true;
